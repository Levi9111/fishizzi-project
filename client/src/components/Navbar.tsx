...
import { HelpCircle, Search, ShoppingCart, Truck, User } from 'lucide-react';
...
const Navbar = () => {
  return (
    <nav className='bg-brand-primary fixed left-0 right-0 z-20'>
      <div className='flex justify-between items-center w-fixedScreen mx-auto py-2'>
        <div className='bg-white h-[60px] flex items-center'>
          <Image src={logo} alt='logo' width={70} height={60} />
        </div>

        <div className=''>
          <ul className='flex items-center justify-center gap-5 text-overlay-white font-semibold '>
